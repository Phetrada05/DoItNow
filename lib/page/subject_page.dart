...
class _SubjectPageState extends State<SubjectPage> {
          ...
          return Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                Text(
                  task == null ? "เพิ่มงานใหม่" : "แก้ไขงาน",
                ...
                ElevatedButton(
                  ...
                  child: const Text("เลือกวัน/เวลา"),
                ),

                if (selectedDate != null)
                  Text(
                    "กำหนดส่ง: ${selectedDate!.day}/${selectedDate!.month}/${selectedDate!.year} "
  ...
  String formatDate(DateTime? date) {
    if (date == null) return "ไม่มีวันกำหนดส่ง";
